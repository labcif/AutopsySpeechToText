...
a = Analysis(['inaSpeechSegmenter/scripts/ina_speech_segmenter.py'],
             ...
             binaries=[],
             datas=[('inaSpeechSegmenter/inaSpeechSegmenter/keras_male_female_cnn.hdf5', 'inaSpeechSegmenter'), ('inaSpeechSegmenter/inaSpeechSegmenter/keras_speech_music_cnn.hdf5', 'inaSpeechSegmenter')],
             hiddenimports=[],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
